...
export const TRANSLATIONS = {
  zh: {
    ...
    importProviderLink: '🔗 导入渠道连接',
    importProviderPlaceholder: '请输入 Cherry Studio 链接，或 NewAPI JSON 连接...',
    btnImport: '导入',
    ...
    providerImportErrors: {
      'missing-import-link': '链接不能为空',
      'invalid-import-link': '无效的链接格式',
      'unsupported-import-link': '不支持的导入链接协议或路径',
      'missing-import-data': '链接中缺少数据参数',
      'invalid-import-data': '链接数据解析失败',
      'missing-provider-id': '服务商 ID 不能为空',
      'invalid-base-url': '无效的 Base URL，必须以 https:// 开头',
      'missing-api-key': 'API Key 不能为空',
    },
    deriveFromModels: '⚙️ 从模型列表生成',
    ...
    removeAllFetchedModels: '取消全部',
    clearAllModels: '一键删除全部',
    customInput: '自定义输入',
    modelId: '模型 ID:',
...
⚠️ 若命中优先级规则，会优先使用规则的 Provider 顺序作为回退链`,
  ...
  en: {
    ...
    importProviderLink: '🔗 Import Channel Connection',
    importProviderPlaceholder: 'Enter a Cherry Studio link or NewAPI JSON connection...',
    btnImport: 'Import',
    ...
    providerImportErrors: {
      'missing-import-link': 'Link cannot be empty',
      'invalid-import-link': 'Invalid link format',
      'unsupported-import-link': 'Unsupported protocol or path in import link',
      'missing-import-data': 'Missing data parameter in import link',
      'invalid-import-data': 'Failed to parse import link data',
      'missing-provider-id': 'Provider ID cannot be empty',
      'invalid-base-url': 'Invalid Base URL, must start with https://',
      'missing-api-key': 'API Key cannot be empty',
    },
    deriveFromModels: '⚙️ Auto-derive from models',
    ...
    removeAllFetchedModels: 'Remove all',
    clearAllModels: 'Delete all',
